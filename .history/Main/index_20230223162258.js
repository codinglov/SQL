  ...
  prompt([
    {
      type: "list",
      name: "choice",
      message: "Pick what you would like what to do ?",
      choices: [
        {
      ...
      prompt([
        {
          type: "list",
          name: "departmentId",
          message: "What department are you trying to view ?",
      ...
      prompt([
        {
          type: "list",
          name: "managerId",
          message: "Whose reports are you looking for?",
      ...
      prompt([
        {
          type: "list",
          name: "employeeId",
          message: "Who do you want to remove as an employee?",
      ...
      prompt([
        {
          type: "list",
          name: "employeeId",
          message: "Who'smanager do you want to update?",
          choices: employeeChoices
        }
      ])
        .then(res => {
